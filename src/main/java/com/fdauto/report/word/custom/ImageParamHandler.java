 ...
 * @version
 */
public class ImageParamHandler implements IFieldMergingCallback {
	private static final Logger log = LoggerFactory
			.getLogger(ImageParamHandler.class);
	...
	public ImageParamHandler(String paramName, double height, double width) {
